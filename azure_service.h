...
public:
    ...
    static Service_azure* Construct(QObject* parent, QNetworkAccessManager* networkAccessManager);
    [[nodiscard]] std::optional<std::string> speak(QUtf8StringView s) override;
    [[nodiscard]] ServiceConfigWidget* getConfigWidget(QWidget*) override;
